...
def get_frenet_frame(x_fine, y_fine, z_fine, x_prime_fine, y_prime_fine, z_prime_fine, x_second_fine, y_second_fine, z_second_fine, x_third_fine, y_third_fine, z_third_fine, t_fine, visualize_all=False):
    ...
    if visualize_all:
        ...
        ax3.plot(t_fine, np.linalg.norm(v_cross_a, axis=1))
        ax3.set_title('v_cross_a')
        ax3.set_xlabel('t')
